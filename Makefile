...
all: boot $(BUILD_OUT)/kernel.bin $(BUILD_OUT)/sqlite.bin $(BUILD_OUT)/vmkernel.lz4 \
     images/os32_boot.d88 programs sdk apps game assets-deployed game-data iso

# === クリーン (全サブモジュール) ===
clean: clean-kernel clean-programs clean-libs clean-images clean-sdk clean-apps clean-game clean-assets clean-deps
