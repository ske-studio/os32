...
check: check-kapi-version check-manifests check-constraints check-privileged check-ne2000-ring check-shlib check-gui-proto check-term-model check-term-render check-t5a-host check-boot-splash-host check-tools-host check-t5b-host check-db-owned-host check-vfs-fd-sqlite-host check-sqlite-groups-host

clean-sdk:
	rm -rf $(SDK_OUT) $(SDK_DIST_DIR)

.PHONY: sdk sdk-dist clean-sdk check-kapi-version check-manifests check-constraints check-privileged check-gui-proto check-term-model check-term-render check-t5a-host check-boot-splash-host check-tools-host check-t5b-host check-db-owned-host check-vfs-fd-sqlite-host check-sqlite-groups-host check
