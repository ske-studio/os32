...
# === カーネル C ソース ===
C_KERNEL = \
    kernel/kernel.c kernel/gdt.c kernel/tss.c kernel/v86.c kernel/v86_test.c kernel/boot_splash.c kernel/idt.c kernel/isr_handlers.c kernel/cpu_calibrate.c \
