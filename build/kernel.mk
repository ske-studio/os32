...
C_KERNEL = \
    ...
    kernel/paging.c kernel/physmem.c kernel/pgalloc.c kernel/memory_boot.c kernel/shlib.c kernel/shm.c kernel/gui.c kernel/kmalloc.c kernel/console.c kernel/con_sink.c kernel/sys.c kernel/sysconfig.c kernel/kselftest.c \
    ...
    exec/exec.c exec/exec_heap.c exec/appslot.c \
