...
/*                                                                          */
/*    [A20ラップ帯域 0x100000-0x10FFFF, 64KB]                                */
/*      0x100000-0x10FFFF  V86 A20ミラー (低位RAM先頭64KBの写像)             */
/*                                                                          */
/*    [カーネル帯域 0x110000-0x1FFFFF, 960KB]                                */
/*      0x110000          カーネルバイナリ (.text+.data+.bss, ~200KB)         */
...
#define KERNEL_LOAD_ADDR      0x110000UL  /* カーネルロードアドレス (1MB+64KB) */

/* V86 A20ラップアラウンド帯域 (0x100000-0x10FFFF) */
#define MEM_A20_WRAP_BASE     0x100000UL
#define MEM_A20_WRAP_SIZE     0x010000UL  /* 64KB */
