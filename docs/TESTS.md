...
| 65 | `check-packages-host` | `python3 -B tools/tests/test_packages.py` | — | — | — | × |
...
| 74 | `check-serial-portc-host` | `python3 -B tools/tests/test_serial_portc.py --mutate` | `drivers/serial_plan.c`<br>`drivers/serial.c`<br>`kernel/sys.c` | — | — | × |
