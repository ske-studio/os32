...
| 41 | `check-kbd-status-host` | `python3 -B tools/tests/test_kbd_status.py --target --mutate` | `drivers/kbd_status.c`<br>`drivers/kbd.c` | [`tools/tests/kbd_status_tdd.md`](../tools/tests/kbd_status_tdd.md) | [`docs/POLICY_DEBUG.md`](POLICY_DEBUG.md) | × |
