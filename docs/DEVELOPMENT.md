...
| 0x40000-0x6FFFF | カーネルヒープ | `kmalloc` 用 |
| 0x3F0000 | KernelAPIテーブル | 固定アドレス |
| 0x400000-0x57EFFF | 外部プログラム | ロード領域およびスタック (1.5MB内) |
| 0x580000-0x6FFFFF | 外部プログラム | 動的ヒープ (sbrk_heap_limit 管理下) |
