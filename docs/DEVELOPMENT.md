...
| LAN (LGY-98) | [tasks/network/PLAN.md](tasks/network/PLAN.md) (M0〜M5、進捗は §9) | `drivers/lgy98.c` `ne2000.c` `ne2000_ring.c` `ne2000_io.asm`、有効化は `make kernel LGY98=1` | `make check` のホスト試験 (リング計算) + NP21/W の `/api/net/*` と `np2net_helper.py` (計画 §8)、ini 追加は [D2] |
