...
- 現在の実装状態: [`FEP_STATUS.md`](../_archived/fep/FEP_STATUS.md)
...
| Phase | ドキュメント | 内容 | 優先度 | 依存 |
|-------|-------------|------|--------|------|
| P1 | [`01_UI_CANDIDATE.md`](01_UI_CANDIDATE.md) | 候補操作の拡充 (↑↓ / 数字 / ページング) | 高 | §1 描画抽象化 |
| P2 | [`02_SCROLL_GUARD.md`](02_SCROLL_GUARD.md) | TVRAM スクロール保護 | 高 | なし |
| P3 | [`03_DICT_COMMAND.md`](03_DICT_COMMAND.md) | 辞書管理シェルコマンド `ime` | 中 | KAPI 公開済 |
| P4 | [`04_DICT_QUALITY.md`](04_DICT_QUALITY.md) | 辞書品質向上 (PRAGMA / 頻度 / 動的切替) | 中 | P3 (切替 UI) |
| P5 | [`05_GFX_MODE.md`](05_GFX_MODE.md) | GFX モード対応 | 高(大規模) | §1 描画抽象化 |
| P6 | [`06_MISC.md`](06_MISC.md) | その他 (XFER / kprintf va_args) | 低 | なし |
| P7 | [`07_BUNSETSU.md`](07_BUNSETSU.md) | 連文節変換 (将来構想・保留) | 低 | 全て |
