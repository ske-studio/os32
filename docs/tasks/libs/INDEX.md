...
> **Note:** 全ライブラリの設計書は実装完了済みのため `_archived/libs/` に移動しました。
...
### tilemap アーカイブ済み (完了タスク)

| ファイル | 内容 |
|---------|------|
| [02_BLIT_COLORKEY_OPT.md](../_archived/tilemap/02_BLIT_COLORKEY_OPT.md) | ブリット＋カラーキー最適化 (完了) |
| [03_ROTATE_BLIT.md](../_archived/tilemap/03_ROTATE_BLIT.md) | 回転ブリット (完了) |
| [04_SCROLL_OPT.md](../_archived/tilemap/04_SCROLL_OPT.md) | スクロール最適化 (完了) |
| [05_SCROLL_ASM_OPT.md](../_archived/tilemap/05_SCROLL_ASM_OPT.md) | スクロール ASM 最適化 (完了) |
| [06_REFACTOR_PLAN.md](../_archived/tilemap/06_REFACTOR_PLAN.md) | リファクタリング計画 (完了) |
