...
> libos32gfx, libos32tilemap, libos32snd, およびゲーム本体が共通して利用する。
...
1. **libos32gfx 以外から使えない** — libos32tilemap, libos32snd, ゲーム本体の
...
- [x] libos32tilemap での利用検証 (math統合済み)
