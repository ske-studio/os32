...
正典: [DESIGN.md](../../tasks/settings/DESIGN.md) §6 (実測項目)、[S0_PLAN_2026-09-13.md](../../tasks/settings/S0_PLAN_2026-09-13.md) §2 (S5 = 実測と受入、PM / テスター)、[TASK_S2.md](TASK_S2.md) §8 (C7 の pool 復帰が未計測: `db_test` が継承バグで落ちる)、[TASK_S4.md](TASK_S4.md) 状態行の残件 4 件。
