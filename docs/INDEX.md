...
| [tasks/memory/TASK_KSTACK_USER.md](tasks/memory/TASK_KSTACK_USER.md) | **カーネルスタックが CPL=3 から書ける 計画 (2026-09-17)** — 0x1F0000〜0x1FFFFF の PTE が P=1/US=1。スタックガードは NP になっておらず、`crash` が落ちずに素通りする (実測、Dirty ビット付き)。**POLICY_DEV §1 で最優先** |
