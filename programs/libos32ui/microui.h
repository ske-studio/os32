...
**
** OS32移植版 — C89互換 + 整数演算のみ + メモリ縮小
*/

#ifndef MICROUI_H
#define MICROUI_H

#define MU_VERSION "2.02-os32"

/* ======================================================================== */
/*  OS32向けバッファサイズ設定 (メモリ節約)                                  */
/* ======================================================================== */
#define MU_COMMANDLIST_SIZE     (16 * 1024)
...
#define MU_TREENODEPOOL_SIZE    16
#define MU_MAX_WIDTHS           8

/* OS32: 浮動小数点を排除して整数 (int) で代用 */
#define MU_REAL                 int
