/* ======================================================================== */
/*  GFX_MATH.C — 整数固定小数点 sin/cos LUT (libos32gfx)                   */
/*                                                                          */
/*  512エントリ × 15bit精度 (値域: -32767 ~ +32767)。                       */
...
/* ======================================================================== */
/*  gfx_isin — 整数sin (512分割角度, 15bit固定小数点)                       */
/*                                                                          */
/*  引数: angle = 0〜511 (0° 〜 360°)。範囲外は自動で正規化される。       */
/*  戻り値: -32767 〜 +32767                                                */
/* ======================================================================== */

i32 gfx_isin(int angle)
{
    return (i32)sin_table[angle & 511];
}

/* ======================================================================== */
/*  gfx_icos — 整数cos (90°オフセットでsinテーブル参照)                    */
/* ======================================================================== */
...
/* ======================================================================== */
/*  gfx_deg_to_idx — 度数(0〜359) を LUTインデックス(0〜511) に変換        */
/*                                                                          */
/*  deg * 512 / 360 を整数で近似: (deg * 91 + 32) >> 6 ≒ deg * 1.4222     */
/* ======================================================================== */

int gfx_deg_to_idx(int deg)
{
    deg = deg % 360;
    if (deg < 0) deg += 360;
    return (deg * 91 + 32) >> 6;
