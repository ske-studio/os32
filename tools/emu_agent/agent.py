...
ホスト側 (ビルド/配備。許可リスト方式で自由なシェルは与えない):
  {"action":"make","target":"kernel"}  make <target> (kernel/kernel-lgy98/kernel-nolgy98/check-net-m2/check-net-m2-cpl3/check-net-m4/programs/sdk/all/check/clean/apps/game/external)
...
MAKE_TARGETS = ("kernel", "kernel-lgy98", "kernel-nolgy98", "check-net-m2", "check-net-m2-cpl3", "check-net-m4", "programs", "sdk", "all", "check", "clean", "deploy",
                "apps", "game", "external")
