...
/* ======================================================================== */
/*  paging_get_pt0 — PDE[0]のページテーブルポインタを取得                    */
/*  V86 A20エミュレーションでマスターPT[0]のコピーを作るために使用           */
/* ======================================================================== */
u32 *paging_get_pt0(void) { return page_tables[0]; }

/* ======================================================================== */
/*  paging_set_pde — PDEエントリを直接設定する                               */
/*  V86用PT差し替え時に PDE[0] を書き換えるために使用                        */
/* ======================================================================== */
void paging_set_pde(u32 pdi, u32 value)
{
    if (pdi >= PAGING_PT_COUNT) return;
    page_directory[pdi] = value;
    if (pg_enabled) tlb_flush_all();
}

/* ======================================================================== */
/*  paging_get_pde — PDEエントリを取得する                                   */
/* ======================================================================== */
u32 paging_get_pde(u32 pdi)
{
    if (pdi >= PAGING_PT_COUNT) return 0;
    return page_directory[pdi];
}
